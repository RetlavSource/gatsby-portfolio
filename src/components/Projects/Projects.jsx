...
const Projects = () => {
  const { projects, certificates } = useContext(PortfolioContext);
  ...
  const sectionBreak = [
    ...
    <Divider key="3" thick="1" bottomSpace="60" percentWidth="30" />,
  ];
                  ...
                  >
                    <div className="project-wrapper__text">
                      ...
                      <div>
                        ...
                        <p className="mb-4">
                          {'youtube' in project ? `Check "${project.youtube}" button below!` : ''}
                        </p>
                      ...
                      {url && (
                        <a
                          ...
                          href={url}
                        >
                          {'youtube' in project ? project.youtube : 'See Live'}
                        </a>
                      )}
